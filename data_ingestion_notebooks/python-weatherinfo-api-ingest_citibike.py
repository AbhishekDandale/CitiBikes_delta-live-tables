...
api_resp_path_weather = '/FileStore/CitiBikes/api_response/weather_info'
...
stationsDF = spark.sql("""
  ...
  FROM (
    ...
    FROM json.`/FileStore/CitiBikes/api_response/station_information`)
  """)
...
api_key = '8a644758cd210773b0e989e07cb4d620'
